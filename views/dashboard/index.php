...
<div class="dash-strip">
    ...
    <div class="dash-strip-card" id="ds-tasks" data-nav="<?= APP_URL ?>/tasks">
    ...
    <div class="dash-strip-card" id="ds-balance" data-nav="<?= APP_URL ?>/finance">
        <div class="dash-strip-icon-wrap">
    ...
    <div class="dash-strip-card" id="ds-workout" data-nav="<?= APP_URL ?>/exercise">
        <div class="dash-strip-icon-wrap">
    ...
    <div class="dash-strip-card" id="ds-subs" data-nav="<?= APP_URL ?>/subscriptions">
        <div class="dash-strip-icon-wrap">
...
<div class="dashboard-grid" id="dashboardGrid">
    ...
    ?>
    <div class="widget" data-widget="<?= h($widget['widget_key']) ?>" style="cursor: pointer;" data-widget-nav="<?= $clickUrl ?>">
